...
import { InsightsPlayerMediaLink, INSIGHTS_PLAYER_MEDIA_SELECT, INSIGHTS_PLAYER_SET_MEDIA_LINKS } from "../components/Insights/Player/Player.definitions";
...
export declare type PublicSegment = {
    id: Segment["id"];
