...
export interface Strings<T = string> extends FrameStrings<T> {
    ...
    /** notification title when incoming CBM task is unsupported */
    IncomingCBMTaskNotSupportedTitle?: T;
    ...
    /** @private Notification text shown when flex is degraded */
    DegradedWarning: T;
    /** Title of notification action for opening status panel @private */
    DegradedNotificationOpenStatusPanelAction: T;
    /** @private Title of notification action for refreshing the age */
    DegradedNotificationRefreshAction: T;
    /** @private Title of notification action for downloading error report */
