...
declare type ParticipantType = "" | "worker" | "customer" | "transfer" | "supervisor" | "agent" | "external" | "unknown";
declare class TelemetryManagerImpl {
    ...
    reportIncomingCBMTaskNotSupported: (reservationSid: string, taskSid: string, channelType?: string) => void;
}
