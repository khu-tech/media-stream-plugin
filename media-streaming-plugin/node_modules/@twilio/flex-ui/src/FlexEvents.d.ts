...
import { TokenPair } from "./core/Insights/Identity/Identity.definitions";
...
export declare enum FlexEvent {
     ...
     * @param {TokenPair} yticaTokenPair new access and refresh token
     * @example
     * import { Manager } from "@twilio/flex-ui";
     * const manager = Manager.getInstance();
...
export declare class FlexEventEmitter extends EventEmitter {
    ...
    emitYticaTokenUpdated(yticaTokenPair: TokenPair): void;
}
