import { ButtonThemeProps, CoreThemeColors, CSSProps, Theme as ControlsTheme } from "@twilio/flex-ui-core";
...
export interface Theme extends ControlsTheme {
    ...
    AppStatusSidebar: {
        ...
        ApplicationStatus: {
            NoIssueContainer: CSSProps;
            WarningContainer: CSSProps;
            DegradedContainer: CSSProps;
