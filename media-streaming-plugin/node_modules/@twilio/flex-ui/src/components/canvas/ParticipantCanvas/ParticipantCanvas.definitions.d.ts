 ...
 * @property {ConferencesState.ConferenceParticipant} participant - Represents a single participant of a conference.
 ...
 * @property {Theme.ParticipantCanvasThemeProps} [theme.ParticipantsCanvas.ParticipantCanvas] - theme.
 */
