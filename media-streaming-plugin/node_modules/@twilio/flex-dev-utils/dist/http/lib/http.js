...
var Http = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (!this.axiosConfig.auth) {
                            throw new errors_1.TwilioCliError("Authorization is required to upload a file");
                        }
                        options = {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                return [2 /*return*/, new Promise(function (resolve, reject) {
                                        http_1.default(config)
                                            // @ts-ignore
                                            .then(function (resp) { return settle_1.default(resolve, reject, resp); })
                                            .catch(reject);
                                    })];
                            });
                        }); };
    ...
    Http.getBaseUrl = function (baseUrl) {
        ...
        if (!Http.REGIONS.includes(region)) {
            throw new errors_1.TwilioCliError("Invalid region " + region + " was provided. Region must be one of " + Http.REGIONS.join(','));
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs.mkdirpSync(dir)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.client.request(config).then(function (buffer) { return fs.writeFile(buffer.toString(), directory); })];
                }
            });
        });
    };
