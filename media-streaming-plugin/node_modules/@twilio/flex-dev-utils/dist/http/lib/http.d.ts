...
export default class Http {
     ...
     */
    static post<R>(uri: string, data: object, options?: AxiosRequestConfig): Promise<R>;
    /**
     ...
     */
    static upload<T>(uri: string, formData: FormData, options?: AxiosRequestConfig): Promise<T>;
    /**
     * Creates an instance of the http client and calls the {@link #download} method.
     */
    static download(url: string, directory: string, config?: AxiosRequestConfig): Promise<void>;
    /**
     ...
     */
    post<R>(uri: string, data: object, options?: AxiosRequestConfig): Promise<R>;
    /**
     ...
     */
    upload<T>(uri: string, formData: FormData, options?: AxiosRequestConfig): Promise<T>;
    /**
     ...
     */
    download(url: string, directory: string, config?: AxiosRequestConfig): Promise<void>;
    /**
